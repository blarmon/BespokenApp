...
public class Follow extends Activity implements ActionBar.TabListener {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				String title1 = "Followers";
				return title1;
			case 1:
				String title2 = "Following";
				return title2;
			}
			return null;
		}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			myWebView1.loadUrl("http://bespokenapp.appspot.com/followers");
	...
	public static class PlaceholderFragment2 extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			myWebView2.loadUrl("http://bespokenapp.appspot.com/following");
